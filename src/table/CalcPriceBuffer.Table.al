table 50100 "Calc. Price Buffer"
{
    ...
    fields
    {
        ...
        field(600; "Allow Line Discount"; Boolean)
        {
            Caption = 'Allow Line Discount';
        }
        field(601; "Allow Invoice Discount"; Boolean)
        {
    ...
    begin
        ...
        //Validate("Customer Disc. Group", '');
        Validate("Customer Disc. Group", Customer."Customer Disc. Group");
    ...
    begin
        ...
        PriceCalculation.ApplyDiscount(); //BUG
