// codeunit 50107 "NetCom GD Json Helper"
// {
...
//         if TryGetTextValueFromJson(ErrorValue, JsonObj, NetComGDTokens.ErrorTok()) then
//             exit(ErrorValue <> '');

//         ClearLastError();
//         if TryGetObjectValueFromJson(ErrorValue, JsonObj, NetComGDTokens.ErrorTok()) then begin
//             InnerJsonObj.ReadFrom(ErrorValue);
//             if TryGetTextValueFromJson(ErrorValue, InnerJsonObj, NetComGDTokens.CodeTok()) then
//                 exit(ErrorValue <> '');
//         end;
