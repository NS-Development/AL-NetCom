// codeunit 50108 "NetCom GD Error Handler"
// {
//     procedure GetError(var NetComGDMethod: Enum "NetCom GD Method"; var GDIErrorValue: Text)
//     begin
...
//     procedure ResponseHasError(CallerMethod: Enum "NetCom GD Method"; ResponseText: Text): Boolean
//     var
...
//         end;
//         if ErrorValue = '' then
//             if not NetComGDJsonHelper.GetErrorValueFromJson(ErrorValue, ResponseJson) then
...
//         Error(CurrentErr, CurrentMethod, CurrentErrorValue);
//     end;
...
//     // local procedure LogError(Problem: Enum "GDI Problem"; Method: Enum "NetCom GD Method";
//     //                                       ErrorValue: Text)
//     // begin
//     //     ClearError();
...
//         CurrentErr: Label 'Method: %1; ErrorValue: %2.', Comment = '%1 = Method name; %2 = Error value (text)';
